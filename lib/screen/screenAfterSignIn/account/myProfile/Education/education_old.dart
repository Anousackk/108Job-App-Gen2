// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, unused_field, prefer_final_fields, unused_local_variable, prefer_if_null_operators, avoid_print, unnecessary_brace_in_string_interps, unnecessary_string_interpolations, sized_box_for_whitespace, prefer_adjacent_string_concatenation, prefer_interpolation_to_compose_strings
      ...
      await showDialog(
        ...
        builder: (context) {
          return NewVer2CustAlertDialogSuccessBtnConfirm(
            ...
            contentText:
                "save".tr + " " + "education".tr + " " + "successfully".tr,
            textButton: "ok".tr,
            press: () {
              Navigator.pop(context);
