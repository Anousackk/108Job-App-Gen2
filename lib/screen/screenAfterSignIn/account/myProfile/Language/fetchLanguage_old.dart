...
class FetchLanguage extends StatefulWidget {
  const FetchLanguage({Key? key, this.onGoBack}) : super(key: key);
...
class _FetchLanguageState extends State<FetchLanguage> {
  ...
  deleteLanguage(String id) async {
    var res = await deleteData(deleteLanguageSeekerApi + id);
    print(res);
                            ...
                            child: Column(
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: _languageSkill.length,
                                  itemBuilder: (context, index) {
                                    dynamic i = _languageSkill[index];
