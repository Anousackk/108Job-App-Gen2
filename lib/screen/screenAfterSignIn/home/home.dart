                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          //                     topBannerProvider.listTopBanners
                          //                                 .length >
                          //                             1
                          //                         ? true
                          //                         : false,
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: AppColors.dark.withOpacity(0.09),
                                        blurRadius: 5,
                                        spreadRadius: 0,
                                        offset: Offset(2, 3),
                                      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "${widget.total}",
            style: bodyTextMaxSmall(null, widget.totalColor, FontWeight.bold),
          ),
        ],
      ),
    );
