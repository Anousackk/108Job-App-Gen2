                        ...
                        child: Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  if (i['item'].every((cx) =>
                                    ...
                                    if (_selectedListItemsChilds
                                        .contains(i['_id'])) {
                                      _selectedListItemsChilds.removeWhere(
                                        (e) => e == i['_id'],
                                      );
                                      ...
                                      for (int parentId = 0;
                                          parentId < _listItemsChilds.length;
                                          parentId++) {
                                        final String idToRemove =
                                            _listItemsChilds[parentId]['_id'];

                                        for (int childId = 0;
                                            childId <
                                                _selectedListItemsChilds.length;
                                            childId++) {
                                          if (_selectedListItemsChilds
                                              .contains(idToRemove)) {
                                            _selectedListItemsChilds
                              ...
                              child: Container(
                                child: i['item'].every((eCheckBoxParents) =>
                                            _selectedListItemsChilds.contains(
                                                eCheckBoxParents['_id'])) &&
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: bodyTextNormal(
                                    _selectedListItemsChilds.contains(i['_id'])
                            ...
                            FaIcon(
                              ...
                              size: IconSize.sIcon,
                              color: _selectedListItemsChilds.contains(i['_id'])
                                  ? AppColors.iconPrimary
                                  : AppColors.iconDark,
                            )
                          ],
                                ...
                                return GestureDetector(
                                  ...
                                  onTap: () {
                                    setState(() {
                                      ...
                                      _selectedListItemsChilds.add(p['_id']);
                                    });
                                  },
                                  child: Container(
                                    padding: EdgeInsets.symmetric(vertical: 15),
